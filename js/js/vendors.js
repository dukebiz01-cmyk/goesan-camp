...
import { state, EVENT_META, INSTRUCTOR_INFO } from "./config.js?v=20260513d";
import { $, esc, toast, won, fmtWeekday } from "./utils.js?v=20260513d";
import { loadEvents, getEventsByProvider } from "./events.js?v=20260513d";
